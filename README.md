...
summary: Transparency Fun static site with configurable featured and per-report cover artwork, standalone reports, shared design, and GitHub Pages deployment.
tags:
- transparency-fun
- projects
- web-design
submodules:
  ...
  scripts/: Public-only static-site packaging script used by GitHub Actions.
